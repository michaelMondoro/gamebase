...
def home():
    """ Main route """
    return render_template('home.html', games=update_data())
...
""" Route to handle/process a user login or signup"""
...
def handle_login():
    ...
    if (request.form['submit'] == "login"):
        ...
        # TODO: Add your signup functionality here
        print("successful signup...")

    return render_template('home.html', games=update_data(), login_success=True)
